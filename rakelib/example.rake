namespace :scoringengine do
  task :example => :environment do
    ...
    property = Property.create(team_id: team.id, server_id: server.id, service_id: service.id, visible: true, category: 'address', property: 'ip', value: '127.0.0.1')
    property = Property.create(team_id: team.id, server_id: server.id, service_id: service.id, visible: true, category: 'option', property: 'from-domain', value: 'scoringengine.ists')
    property = Property.create(team_id: team.id, server_id: server.id, service_id: service.id, visible: true, category: 'option', property: 'rcpt-domain', value: 'scoringengine.ists')
    user = User.create(team_id: team.id, server_id: server.id, service_id: service.id, username: 'test', password: 'test')
